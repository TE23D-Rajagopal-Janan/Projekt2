...
public class Main {
    public static void main(String[] args) {
        ...
        Scanner scanner = new Scanner(System.in); // skapar ett scanner objeckt som läser in användarens val från
                                                  // tangentbordet
        ...
        Gson gson = new GsonBuilder().setPrettyPrinting().create(); // skapar en ny gason så att vi inte behöver använda
                                                                    // den på alla
        ...
        while (meny) {
            ...
            if (choice == 1) {
                HttpResponse<String> response = Unirest.get("http://10.151.168.5:3111/books").asString(); // programet
                                                                                                          // skicakr en
                                                                                                          // request
                                                                                                          // till
                                                                                                          // servern,
                ...
                }.getType(); // säger för Gson att JSON datat ska bli en lista med böcker
                ...
                HttpResponse<String> response = Unirest.get("http://10.151.168.5:3111/magazines").asString(); // skickar
                                                                                                              // request
                                                                                                              // om att
                                                                                                              // få
                                                                                                              // magazines.
                ...
                Unirest.post("http://10.151.168.5:3111/books").header("Content-Type", "application/json").body(json)
                        .asString(); // berättar att vi skickar in data som json
                ...
                Unirest.post("http://10.151.168.5:3111/magazines").header("Content-Type", "application/json").body(json)
                        .asString();
                ...
                Unirest.post("http://10.151.168.5:3111/suspended").header("Content-Type", "application/json").body(json)
                        .asString();
                ...
                Unirest.post("http://10.151.168.5:3111/users").header("Content-Type", "application/json").body(json)
                        .asString();
